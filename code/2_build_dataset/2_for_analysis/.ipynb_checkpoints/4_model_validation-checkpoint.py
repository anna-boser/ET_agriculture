...
def spatial_split(dist):
    ...
    for i, (train_idx, test_idx) in enumerate(split):
        ...
        regressor.set_params(parameters) # use the parameters from the randomized search
    ...
    cv_df.to_csv(outpath+"/sklearn_RF_full_cv_outputs_", dist, ".csv", index=False)
    ...
    # save this df
    cv_stats.to_csv(outpath+"/sklearn_RF_cv_fold_stats_", dist, ".csv", index=False)
    ...
    # save this df
    spatial_cv.to_csv(outpath+"/sklearn_RF_cv_validation_stats_", dist, ".csv", index=False)
