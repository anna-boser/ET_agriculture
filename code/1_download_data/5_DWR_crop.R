...
unzip(here("data", "raw", "DWR_crop", "DWR_crop.zip"), exdir = here("data", "raw", "DWR_crop", "2018"))
...
unzip(here("data", "raw", "DWR_crop", "DWR_crop2019.zip"), exdir = here("data", "raw", "DWR_crop", "2019"))
