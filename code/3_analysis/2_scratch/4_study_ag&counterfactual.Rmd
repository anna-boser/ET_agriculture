...
```{r}
DWR_buffer <- st_buffer(DWR_flat, 10000) # 10 km buffer. Use st_crs(DWR_flat) to see that the unit for this projection is meters (also checked it makes sense in google maps)
